...
class add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.fill_names(wd, "fklgkjdflnhjl", "k;dlgh;jd;d", "45454544", "545454545454454")
        self.fill_company(wd, "5646565465", "89494984", ".13213621136")
        self.fill_numbers(wd, "48943898", "684646466", "4989+841648", "4984968494648")
        self.fill_emails(wd, "64646846846", "4648616168", "646468431")
        self.fill_home_page(wd, "68468465168")
        self.fill_dates(wd)
        self.choose_group(wd)
        self.fill_double_addresses(wd, "78447080", "5698", "4897")
    ...
    def fill_double_addresses(self, wd, address2, phone2, notes):
    ...
    def fill_home_page(self, wd, contact_homepage):
        wd.find_element_by_name("homepage").click()
        wd.find_element_by_name("homepage").clear()
        wd.find_element_by_name("homepage").send_keys(contact_homepage)

    def fill_emails(self, wd, origin_mail, second_mail, third_mail):
        wd.find_element_by_name("email").click()
        wd.find_element_by_name("email").clear()
        wd.find_element_by_name("email").send_keys(origin_mail)
        wd.find_element_by_name("email2").click()
        wd.find_element_by_name("email2").clear()
        wd.find_element_by_name("email2").send_keys(second_mail)
        wd.find_element_by_name("email3").click()
        wd.find_element_by_name("email3").clear()
        wd.find_element_by_name("email3").send_keys(third_mail)

    def fill_numbers(self, wd, home_phone, mobile_phone, work_phone, fax):
    ...
    def fill_company(self, wd, title, company, address):
    ...
    def fill_names(self, wd, first_name, middle_name, last_name, nickname):
